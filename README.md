...
*   0.1.10（2012/03/20）
    *   ［改善］トップページの生成が遅かった不具合の修正、FeedHelperを改善
    *   ［修正］スクリプトのパスがまちがっていたのを修正
    *   ［改善］アーカイブリストのキャッシュ生成時刻を public に
    *   ［改善］アーカイブの変更時刻をローカルタイム表示に
    *   ［修正］リモートサーバーに配置した時、Application_Start() で HttpContext.Current.Request を参照できなかった問題に対する対応
*   0.1.9（2012/03/18）
